...
const HeroButtons = () => {
  ...
  const buttonClass =
    "relative inline-flex w-[125px] h-[35px] sm:w-[130px] sm:h-[38px] md:w-[145px] md:h-[45px] lg:w-[160px] lg:h-[48px] 2xl:w-[204px] 2xl:h-[59px] overflow-hidden rounded p-[2px] focus:outline-none";
