  ...
  return (
    <div className="flex justify-between items-center mt-[50px] md:mt-[105px] 2xl:mt-[121px]">
      <div className="flex flex-col md:flex-row w-[76.85%] justify-between font-inter text-white text-[10px] sm:text-[11px] md:text-[12px] lg:text-[14px] 2xl:text-[16px] gap-[5px]">
        <button className="relative inline-flex w-[125px] h-[35px] sm:w-[130px] sm:h-[38px] md:w-[145px] md:h-[45px] lg:w-[160px] lg:h-[48px] 2xl:w-[204px] 2xl:h-[59px] overflow-hidden rounded p-[2px] focus:outline-none focus:ring-1 focus:ring-slate-400 focus:ring-offset-1 focus:ring-offset-slate-50">
